    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          >
            <Waves size={26} style={{ color: '#0EA5E9' }} />
          </div>
          ...
          <p className="font-body text-sm" style={{ color: '#6B8CAE' }}>
            Join AstroWave — it only takes one click
          </p>
        </div>
        ...
        <p className="text-center font-body text-xs mt-6 leading-relaxed" style={{ color: '#6B8CAE' }}>
          ...
          <Link href="/auth/login" className="text-[#0EA5E9] font-bold hover:underline">
            Sign in →
          </Link>
        </p>
      ...
      <div className="text-center">
        <Link href="/" className="font-body text-xs transition-colors hover:text-[#0EA5E9] font-bold uppercase tracking-widest" style={{ color: '#6B8CAE' }}>
          ← Back to AstroWave
        </Link>
      </div>
    </div>
