...
// Scanner credentials (in production, use env vars or database)
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      if (username === SCANNER_CREDENTIALS.username && password === SCANNER_CREDENTIALS.password) {
        // Store scanner auth in sessionStorage
    ...
    <div className="min-h-screen flex items-center justify-center px-6" style={{ background: '#090909' }}>
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-2xl uppercase tracking-wider" style={{ color: '#F5F5F5' }}>Ticket Scanner</h1>
          <p className="text-xs mt-1" style={{ color: '#B4B4B4' }}>Mask Mirage Party — Staff Access</p>
        </div>
