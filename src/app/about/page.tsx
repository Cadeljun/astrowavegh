    ...
    <div className="flex flex-col w-full">
      <section className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-black">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl">
          ...
          <motion.h1 variants={heroTextReveal} initial="hidden" animate="show" className="display-2xl text-glow-blue mb-6 whitespace-pre-line">{hero.heading}</motion.h1>
      ...
      <section className="py-32 px-6 lg:px-12 bg-surface">
        <div className="max-w-screen-2xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          <motion.div variants={scaleIn} initial="hidden" whileInView="show" viewport={{ once: true }}>
            <Card className="p-10 border-t-2 border-t-green bg-card relative overflow-hidden group" glowColor="green">
              <span className="absolute -top-4 -right-4 text-[10rem] font-display text-green opacity-[0.05] leading-none pointer-events-none">"</span>
      ...
      <section className="bg-light py-32 px-6 lg:px-12 relative" style={{ clipPath: 'polygon(0 40px, 100% 0, 100% 100%, 0 100%)' }}>
        <div className="max-w-screen-2xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          <motion.div variants={scaleIn} initial="hidden" whileInView="show" viewport={{ once: true }}>
            <Card className="p-10 h-full border-t-2 border-t-green" glowColor="green">
          ...
          <motion.div variants={scaleIn} initial="hidden" whileInView="show" viewport={{ once: true }} transition={{ delay: 0.2 }}>
            <Card className="p-10 h-full border-t-2 border-t-blue" glowColor="blue">
          ...
          <motion.div variants={staggerContainer} initial="hidden" whileInView="show" viewport={{ once: true }} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {values.map((v, i) => (
              <motion.div key={i} variants={scaleIn}>
                <Card className="p-10 text-center group" glowColor={v.color as any}>
